          ...
          messages: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: "Hãy mô tả hình ảnh từ khái quát đến chi tiết, càng chi tiết càng tốt. Mô tả ảnh phải hợp lý và chi tiết về không gian và hãy mô tả với chất lượng tốt nhất có thể để giúp người khiếm thị nhận biết và có trải nghiệm thật chính xác. Mô tả phải chân thực và chính xác, không bỏ sót bất kỳ chi tiết nào, không được thay đổi sự thật và bịa đặt về chi tiết không có thật trong hình ảnh, nếu không chắc chắn thì phải nói là không chắc chắn. Nếu trong ảnh có chữ bằng Tiếng Anh hoặc ngôn ngữ khác, hãy giữ nguyên nó trong câu trả lời sau đó dịch sang Tiếng Việt. NẾU hình ảnh có (hoặc bao gồm) phần tử có vẻ như hoặc là mã CAPTCHA, hoặc có giao diện như đang cung cấp mã CAPTCHA, hãy nhấn mạnh vào mã CAPTCHA đó khi đã được giải mã OCR (phải thật chính xác, không được sai sót dù chỉ một ký tự). Hãy luôn trả về ngay mô tả hình ảnh, không cần giới thiệu hay nhắc lại yêu cầu.",
                },
                {
                  type: "image_url",
